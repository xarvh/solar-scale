...
var _user$project$Main$formatNumber = _cuducos$elm_format_number$FormatNumber$format(_cuducos$elm_format_number$FormatNumber_Locales$usLocale);
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'ChangeUnit') {
			...
			return _elm_lang$core$Native_Utils.update(
				model,
				{selectedSunDiameterAsString: _p0._0});
		}
	});
var _user$project$Main$init = {selectedSunDiameterAsString: '', unit: 'cm'};
var _user$project$Main$realSunRadius = 6.95e8;
var _user$project$Main$objects = {
	ctor: '::',
	_0: {
		name: 'Sun',
		radius: _elm_lang$core$Maybe$Just(_user$project$Main$realSunRadius),
		distance: 0
	},
	_1: {
		ctor: '::',
		_0: {
			name: 'Mercury',
			radius: _elm_lang$core$Maybe$Just(2440000.0),
			distance: 5.79e10
		},
		_1: {
			ctor: '::',
			_0: {
				name: 'Venus',
				radius: _elm_lang$core$Maybe$Just(6052000.0),
				distance: 1.08e11
			},
			_1: {
				ctor: '::',
				_0: {
					name: 'Earth',
					radius: _elm_lang$core$Maybe$Just(6378000.0),
					distance: 1.5e11
				},
				_1: {
					ctor: '::',
					_0: {
						name: 'Mars',
						radius: _elm_lang$core$Maybe$Just(3397000.0),
						distance: 2.28e11
					},
					_1: {
						ctor: '::',
						_0: {
							name: 'Jupiter',
							radius: _elm_lang$core$Maybe$Just(7.1492e7),
							distance: 7.78e11
						},
						_1: {
							ctor: '::',
							_0: {
								name: 'Saturn',
								radius: _elm_lang$core$Maybe$Just(6.0268e7),
								distance: 1.43e12
							},
							_1: {
								ctor: '::',
								_0: {
									name: 'Uranus',
									radius: _elm_lang$core$Maybe$Just(2.5559e7),
									distance: 2.87e12
								},
								_1: {
									ctor: '::',
									_0: {
										name: 'Neptune',
										radius: _elm_lang$core$Maybe$Just(2.4766e7),
										distance: 4.5e12
									},
									_1: {
										ctor: '::',
										_0: {
											name: 'Pluto',
											radius: _elm_lang$core$Maybe$Just(1150000.0),
											distance: 5.91e12
										},
										_1: {
											ctor: '::',
											_0: {name: 'Kuiper Belt (inner edge)', radius: _elm_lang$core$Maybe$Nothing, distance: 4.5e12},
											_1: {
												ctor: '::',
												_0: {name: 'Kuiper Belt (outer edge)', radius: _elm_lang$core$Maybe$Nothing, distance: 7.5e12},
												_1: {
													ctor: '::',
													_0: {name: 'Alpha Centauri', radius: _elm_lang$core$Maybe$Nothing, distance: 4.07e16},
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$Main$viewRow = F3(
	function (selectedSunRadius, unit, obj) {
		var scale = function (n) {
			return (n * selectedSunRadius) / _user$project$Main$realSunRadius;
		};
		var diameterText = function () {
			var _p1 = obj.radius;
			if (_p1.ctor === 'Nothing') {
				return '';
			} else {
				return A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Main$formatNumber(
						scale(_p1._0) * 2),
					unit);
			}
		}();
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(obj.name),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(diameterText),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(distanceText),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Main$viewObject = F3(
	function (status, unit, obj) {
		var _p2 = status;
		switch (_p2.ctor) {
			case 'BadNumber':
				return _elm_lang$html$Html$text('');
			case 'NoInput':
				return A3(_user$project$Main$viewRow, _user$project$Main$realSunRadius / 1000, 'km', obj);
			default:
				return A3(_user$project$Main$viewRow, _p2._0, unit, obj);
		}
	});
var _user$project$Main$Object = F3(
	function (a, b, c) {
		return {name: a, radius: b, distance: c};
	});
var _user$project$Main$Model = F2(
	function (a, b) {
		return {selectedSunDiameterAsString: a, unit: b};
	});
var _user$project$Main$ChangeSize = function (a) {
	return {ctor: 'ChangeSize', _0: a};
};
var _user$project$Main$ChangeUnit = function (a) {
	return {ctor: 'ChangeUnit', _0: a};
};
var _user$project$Main$Radius = function (a) {
	return {ctor: 'Radius', _0: a};
};
var _user$project$Main$BadNumber = {ctor: 'BadNumber'};
var _user$project$Main$NoInput = {ctor: 'NoInput'};
var _user$project$Main$view = function (model) {
	var status = function () {
		if (_elm_lang$core$Native_Utils.eq(model.selectedSunDiameterAsString, '')) {
			return _user$project$Main$NoInput;
		} else {
			var _p3 = _elm_lang$core$String$toFloat(model.selectedSunDiameterAsString);
			if (_p3.ctor === 'Err') {
				return _user$project$Main$BadNumber;
			} else {
				return _user$project$Main$Radius(_p3._0 / 2);
			}
		}
	}();
	return A2(
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('mt'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('If the Sun had a diameter of '),
							_1: {
								ctor: '::',
								_0: A2(
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$ChangeUnit),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$disabled(
														_elm_lang$core$Native_Utils.eq(status, _user$project$Main$NoInput) || _elm_lang$core$Native_Utils.eq(status, _user$project$Main$BadNumber)),
													_1: {ctor: '[]'}
												}
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$value('cm'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('cm'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$value('m'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$value('in'),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('...then the objects in the Solar System would have:'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								},
								{
												...
												{ctor: '[]'},
												{
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Diameter'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Distance from the Sun'),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
									...
									_1: {
										...
										_0: A2(
											...
											A2(
												_elm_lang$core$List$map,
												A2(_user$project$Main$viewObject, status, model.unit),
												_user$project$Main$objects)),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
